...
id: EV-W0F-R9
type: evidence
title: W0F re-attested at the per-tier renewal matchers (Codex round-6 disposition)
status: superseded
superseded_by: EV-W0F-R10
work: W0F
result: pass
commands:
...
input_fingerprint: sha256:e1387122b50b30bf42864a915ddeae1c83d83155cd9bb07170a85864d8876539
environment: python 3.13.7 (win32-x64), git 2.x, local
supersedes: [EV-W0F-R8]
updated: 2026-07-26
---

# EV-W0F-R9 — W0F verification receipt (re-attested)
...
`npm test` -> **384/384**, `tsc` -> exit 0. Bundle divergence addendum (INS-006): RETIRED_RENEWAL_PROXIMITY_RE added, RETIRED_RENEWAL_RE gains obligation forms, standing loop uses proximity; selftest.py +2 cases.

`contract_fingerprint` is byte-identical to EV-W0F-R8's. Only `input_fingerprint` moved.
