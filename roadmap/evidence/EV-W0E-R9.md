...
id: EV-W0E-R9
type: evidence
title: W0E re-attested at the per-tier renewal matchers (Codex round-6 disposition)
status: superseded
superseded_by: EV-W0E-R10
work: W0E
result: pass
commands:
...
input_fingerprint: sha256:85af8bacf2a626318d97af22076e786f63b250dc736823821004a38a16dd917d
environment: python 3.13.7 (win32-x64), git 2.x, local
supersedes: [EV-W0E-R8]
updated: 2026-07-26
---

# EV-W0E-R9 — W0E verification receipt (re-attested)
...
W0E's rejection surface now includes obligation-form renewal instructions on both tiers, red-first evidence per case.

`contract_fingerprint` is byte-identical to EV-W0E-R8's. Only `input_fingerprint` moved.
