...
id: EV-W0B-R12
type: evidence
title: W0B re-attested at unbounded standing co-occurrence (Codex round-9 disposition)
status: superseded
superseded_by: EV-W0B-R13
work: W0B
result: pass
commands:
...
input_fingerprint: sha256:626e5c2f3182d198af56c5f7b5a163ae51bcc991699896eae4930bf0856c2f86
environment: python 3.13.7 (win32-x64), git 2.x, local
supersedes: [EV-W0B-R11]
updated: 2026-07-26
---

# EV-W0B-R12 — W0B verification receipt (re-attested)
...
Sixteen instructional cases, all red-first. `selftest.py` -> **OK, 0 failing**.

`contract_fingerprint` is byte-identical to EV-W0B-R11's. Only `input_fingerprint` moved.
